...
//        допустим что по закону алкоголь можно покупать с 18 лет
    ...
    public static String possibilitySellAlkohol(int customerAge) {
        ...
        хотел решить не прописывая большое количество кейсов (если задача была бы приближена к реальной), но для
        этого понадобился бы метод .valueOf() и вместо switch можно использовать if\else
         */
